...
class Remote_Source {
    ...
    public function test_connection() {
        ...
        if ( empty( $remote_url ) ) {
            $results['message'] = __( 'Remote URL not configured', 'remote-featured-plugins' );
            return $results;
        }
        ...
        if ( false === $slugs ) {
            $results['message'] = __( 'Failed to fetch data from remote source', 'remote-featured-plugins' );
            return $results;
        }
        ...
        $results['message'] = sprintf(
            ...
            __( 'Successfully fetched %d plugin slugs', 'remote-featured-plugins' ),
